...
public class db {
    ...
    public static void printCountries(ArrayList<com.napier.sem.classes.Country> countries) {
        for (com.napier.sem.classes.Country country : countries) {
    ...
    public ArrayList<com.napier.sem.classes.Country> getAllCountriesSortedByPopulation(String baseQuery, int n) {
        ArrayList<com.napier.sem.classes.Country> countries = new ArrayList<>();
        try {
            ...
            while (rset.next()) {
                com.napier.sem.classes.Country country = new com.napier.sem.classes.Country();
    ...
    public ArrayList<com.napier.sem.classes.Country> getCountriesWithPopulationGreaterThan(int minPopulation) {
        ArrayList<com.napier.sem.classes.Country> countries = new ArrayList<>();
    ...
    public boolean insertCountry(com.napier.sem.classes.Country country) {
